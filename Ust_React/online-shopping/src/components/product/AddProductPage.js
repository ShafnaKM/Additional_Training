...
const AddProductPage = () => {
  ...
  let [validProductDescription, updateValidProductDescription] =
    useState(false);
  ...
  let [productDescriptionValidMessage, updateProductDescriptionValidMessage] =
    useState("");
    ...
    switch (inputName) {
      ...
      case "productName":
        ...
        updateProductNameValidMessage(
          "Product Name should be minimum 5 characters"
        );
        break;
      case "productPrice":
      ...
      case "productDescription":
        ...
        updateProductDescriptionValidMessage(
          "Product Description should be minimum 10 characters"
        );
        break;
    }
    ...
    <div className="container">
      ...
      >
        <div className="form-group">
          ...
          />
          {!validProductId ? (
            <p className="text-danger">{prodctIdValidMessage}</p>
          ) : (
            <p></p>
          )}
        </div>
        <div className="form-group">
          ...
          />
          {!validProductName ? (
            <p className="text-danger">{productNameValidMessage}</p>
          ) : (
            <p></p>
          )}
        </div>
        <div className="form-group">
          ...
          />
          {!validProductPrice ? (
            <p className="text-danger">{productPriceValidMessage}</p>
          ) : (
            <p></p>
          )}
        </div>
        <div className="form-group">
          ...
          />
          {!validProductDescription ? (
            <p className="text-danger">{productDescriptionValidMessage}</p>
          ) : (
            <p></p>
          )}
        </div>
      ...
      <ToastContainer position="middle-center">
        ...
        >
          ...
          <Toast.Body>Product has been added successfully</Toast.Body>
          <Toast.Body>
            <button
              className="btn btn-primary"
              onClick={() => {
